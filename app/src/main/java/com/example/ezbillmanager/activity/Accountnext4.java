...
public class Accountnext4 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accountnext4);
        ...
        btn_return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Accountnext4.this, home_page.class);
        ...
        btn_save.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                int back = NetManager.getInstance().addBill(82374832,"str","行",t);
                if(back==1){
                    Intent intent = new Intent(Accountnext4.this, home_page.class);
                    startActivity(intent);
                }else{
