...
import com.example.ezbillmanager.*;

import androidx.appcompat.app.AppCompatActivity;

import com.example.ezbillmanager.R;

public class Accountnext1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accountnext1);
        ...
        btn_return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Accountnext1.this, home_page.class);
        ...
        btn_save.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                int back = NetManager.getInstance().addBill(82374832,"str","衣",t);
                if(back==1){
                    Intent intent = new Intent(Accountnext1.this, home_page.class);
                    startActivity(intent);
                }else{
